node('docker') {
    ...
    stage 'Integration Test'
        ...
        sh "bash resources/auto-mc-server-full.sh -g 1 -w Toast -v 1.12.2 -f https://www.feed-the-beast.com/projects/ftb-presents-direwolf20-1-12/files/2690320 -e /opt/jenkins-haproxy/jenkins/jenkins-home/worlds/Toast -t states/mc-server-java-jenkins.tfvars -y"
}