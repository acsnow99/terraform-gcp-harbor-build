node('docker') {
    ...
    stage 'Integration Test'
        ...
        sh "bash resources/auto-mc-server-full.sh -y -g 1 -w Toast -e /opt/jenkins-haproxy/jenkins/jenkins-home/worlds/Toast -v 1.12.2 -t states/mc-server-java-jenkins.tfvars"
}